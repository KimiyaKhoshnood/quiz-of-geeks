...
export default function QuizGame() {
  ...
  const [answers, setAnswers] = useState<(answersState | null)[]>(
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-md text-center w-96">
        {!gameStarted ? (
          <button
            className="px-4 py-2 bg-gradient-to-b from-emerald-600 to-emerald-700 text-white rounded-lg"
